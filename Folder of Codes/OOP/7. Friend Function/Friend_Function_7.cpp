//Operate on objects of two different class using friend function (3:25pm,3 May,2020 & 9:53pm,15 August,2020)
...
/*
using friend function we can access private data member of two or more classes and then can take input,initialize,manipulate the private
data members together so it makes our task easy
*/
