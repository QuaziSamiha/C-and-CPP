// Initialization List in Constructor  (9:46pm,16 May,2020 & 9:44am,19 August,2020)
#include<iostream>
...
public :
    class_2(int p1, int p2) : data_member_1_class_2(p1), data_member_2_class_2(p1*p2) //initialization list in constructor
    {
